...
{
    public class ShinryouCheckAction前回算定日を表示 : IShinryouCheckAction
    {
        public static readonly IShinryouCheckAction Instance = new ShinryouCheckAction前回算定日を表示();

        public ShinryouCheckRuleType RuleType => ShinryouCheckRuleType.前回算定日を表示;
